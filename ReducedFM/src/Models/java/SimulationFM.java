...
public class SimulationFM extends CoupledModelImpl implements StateVariableBased{ 
	...
	public void make(){
		...
		addChildModel(StimulusGenerator);
		Gateway Gateway = new Gateway();
		addChildModel(Gateway);
		Sensor1 Sensor1 = new Sensor1();
		addChildModel(Sensor1);
		addCoupling(StimulusGenerator.outStimulus2,Sensor2.inStimulus2);
		addCoupling(StimulusGenerator.outStimulus1,Sensor1.inStimulus1);
		addCoupling(Sensor2.outDepth,Gateway.inDepth);
		addCoupling(Sensor1.outDepth,Sensor2.inDepth);
